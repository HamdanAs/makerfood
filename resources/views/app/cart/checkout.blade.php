        ...
        <div class="w-3/5 bg-white shadow-lg rounded-md h-fit">
          ...
          <div class="p-3">
            ...
            <ul class="grid gap-3 w-full md:grid-cols-2">
              <li>
                <input type="radio" id="deliver" name="delivery_method" value="1" class="hidden peer">
              ...
              <li>
                <input type="radio" id="pickup" name="delivery_method" value="2" class="hidden peer">
            ...
            <ul class="grid gap-3 w-full md:grid-cols-2">
              <li>
                <input type="radio" id="cod" name="payment_method" value="1" class="hidden peer">
              ...
              <li>
                <input type="radio" id="transfer" name="payment_method" value="2" class="hidden peer">
        ...
        <div class="w-2/5 h-fit">
          <div class="bg-white shadow-lg rounded-md">
            ...
            <div class="flex justify-end p-3">
              <button type="submit" class="px-5 py-1 bg-blue-500 text-white rounded-md">Bayar</button>
            </div>
          </div>
        </div>
      </div>
