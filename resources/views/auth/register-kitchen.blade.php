      ...
      <div class="w-1/2 p-10 flex justify-center items-center">
        <div class="w-3/4">
          ...
          <form method="POST" action="{{ route('register') }}" class="mt-4">
            ...
            <!-- Name -->
            <div class="mt-4">
              <x-input-label for="name" :value="__('Alamat Dapur')" />

              <x-text-area id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus ></x-text-area>
